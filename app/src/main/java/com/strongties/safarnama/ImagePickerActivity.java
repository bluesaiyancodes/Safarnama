...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    public static void showImagePickerOptions(Context context, PickerOptionListener listener) {
        ...
        builder.setTitle(context.getString(R.string.label_set_dp));

        // add a list
        String[] animals = {context.getString(R.string.label_take_camera_picture), context.getString(R.string.label_choose_from_gallery)};
    ...
    private void takeCameraImage() {
        Dexter.withActivity(this)
                .withPermissions(android.Manifest.permission.CAMERA, android.Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE)
