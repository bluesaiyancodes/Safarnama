                                ...
                                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        if (document.exists()) {
                                            ...
                                            LatLng place = new LatLng(landmarkMeta.getGeoPoint().getLatitude(), landmarkMeta.getGeoPoint().getLongitude());
                                            googleMap.addMarker(new MarkerOptions().position(place).title(landmarkMeta.getLandmark().getName())
                                                    .snippet(landmarkMeta.getCategory() + "  " + mContext.getString(R.string.i_circle))
