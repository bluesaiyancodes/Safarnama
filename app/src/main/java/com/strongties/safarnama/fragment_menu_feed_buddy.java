...
public class fragment_menu_feed_buddy extends Fragment {
    private RecyclerViewAdapter_feed adapter_feed = null;


    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.layout_screen_feed_buddy, container, false);


        RecyclerView myrecyclerview = root.findViewById(R.id.rv_feed_v2_buddy);
